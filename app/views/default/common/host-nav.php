...
<div class="pv-10">
  <div class="panel panel-default ">
    <div class="panel-heading">
      <a href="/host-group/detail?id=<?php echo $parent["postid"];?>">
      <?php echo $parent["title"];?>
      </a>
      <a href="/host/add" class="btn btn-primary btn-xs right">
    ...
    <div class="host-group-basic-nav collapse in panel-collapse ">
      <div class="list-group">
        <?php foreach($posts as $post){
          ...
          ?>
          <a href="/host/detail?id=<?php echo $post["postid"];?>" class="list-group-item">
            <?php echo $post["title"];?>
